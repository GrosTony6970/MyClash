...
export const en = {
  ...
  scoring: {
    ...
    desk: {
      ...
      markArrived: 'Arrived',
      undo: 'Undo',
      arrivedCount: '{arrived} / {total} arrived',
      missingAtRisk: 'Missing at risk',
      missingTitle: 'Missing at risk',
      backToDesk: 'Desk',
    ...
    gear: {
      title: 'Gear check',
      checkedCount: '{checked} / {total} gear-checked',
    ...
    hemaRatings: {
      ...
      warnings: {
        ...
        tournament_name_missing_material:
          'Tournament names with no material (Steel / Nylon / Wood)',
...
export const fr = {
  ...
  publicApp: {
    ...
    home: {
      ...
      filterResultCount: '{count} evenements',
    ...
    me: {
      ...
      organizers: {
        ...
        emptyHint:
          "Trouvez-en un dans l'annuaire, ou sur la page d'un évènement, puis cliquez sur Suivre.",
    ...
    organizer: {
      ...
      metaDescription: 'Évènements organisés par {name} sur MyClash.',
      eventCount: '{count} évènements',
      sectionUpcoming: 'Évènements à venir',
      sectionPast: 'Évènements passés',
    ...
    organisers: {
      ...
      metaDescription:
        'Parcourez les clubs et fédérations qui organisent des évènements sur MyClash.',
      title: 'Organisateurs',
      subtitle: 'Suivez un organisateur : vous serez notifié quand il publiera un évènement.',
      ...
      upcomingCount: '{count} évènements à venir',
      noUpcoming: 'Aucun évènement à venir',
      previous: 'Précédent',
      next: 'Suivant',
  ...
  scoring: {
    login: {
      ...
      picker: {
        label: 'Évènement',
        tabsLabel: 'Quels évènements afficher',
        live: 'En cours',
        upcoming: 'À venir',
        loading: 'Recherche des évènements...',
        empty:
          "Aucun évènement n'est encore configuré pour la connexion staff. Saisissez le slug à la place.",
  ...
  admin: {
    ...
    users: {
      ...
      create: {
        ...
        loginEmail: 'Email de connexion',
        temporaryPassword: 'Mot de passe temporaire',
        roleGranted: 'Role plateforme accorde : {role}',
      },
      actions: {
        edit: 'Modifier',
        enable: 'Activer',
      ...
      edit: {
        ...
        platformRoleSection: 'Role plateforme',
        platformRoleConfirm: 'Changer le role plateforme de ce compte ?',
        platformRoleFailed: 'Impossible de changer le role plateforme.',
        platformRoleSelfDisabled: 'Vous ne pouvez pas changer votre propre role plateforme.',
        passwordSection: 'Mot de passe',
        regeneratePassword: 'Generer un nouveau mot de passe',
        regeneratePasswordHelp:
          'Remplace le mot de passe par une nouvelle valeur a usage unique, affichee une seule fois. A utiliser quand la personne ne peut pas recevoir d email.',
        regeneratePasswordConfirm:
          'Remplacer le mot de passe de ce compte ? Son mot de passe actuel cesse de fonctionner immediatement.',
        regeneratePasswordFailed: 'Impossible de generer un nouveau mot de passe.',
        sendResetEmail: 'Envoyer un email de reinitialisation',
        sendResetEmailHelp:
          'Envoie un lien de recuperation pour que le compte choisisse son mot de passe. Rien ne change tant qu il ne l utilise pas.',
        sendResetEmailConfirm: 'Envoyer un lien de reinitialisation a ce compte ?',
        sendResetEmailSent: 'Email envoye',
        sendResetEmailFailed: 'Impossible d envoyer l email de reinitialisation.',
    ...
    featureFlags: {
      ...
      disableHemaSync: {
        ...
        description:
          'Mettre en pause le cron HEMA Ratings quotidien (03:30 UTC) ET le sync ponctuel par combattant depuis le finder. La lecture locale du snapshot et la recherche continuent. A activer si hemaratings.com limite les requetes ou renvoie des donnees corrompues.',
      },
      disableEmail: {
    ...
    rulesets: {
      ...
      tiebreakersTitle: 'Tie-breakers',
      tiebreakersHelp:
        'Appliques dans l ordre quand les combattants ont le meme score. Plus haut = les plus grandes valeurs sont mieux classees.',
      ...
      deepHelp: {
        ...
        afterblow:
          "Une riposte portee apres avoir ete touche. L'activer change plus que les points : le combattant qui a touche EN PREMIER est compte comme ayant ete touche, et les touches recues forment le bas du score de poule - son score baisse donc meme quand il a gagne l'echange.",
        afterblowValuation:
        ...
        afterblowMode:
          "Complet : chaque combattant garde les points de ses boutons. Deductif : la riposte est retranchee a l'attaquant (jamais en dessous de zero) et celui qui l'a portee ne marque rien - se faire toucher en retour coute a l'attaquant au lieu de rapporter au defenseur. Les echanges stockent toujours les boutons bruts, donc changer ce mode relit tous les echanges deja enregistres.",
        doublePenalty:
    ...
    penaltyRulesets: {
      ...
      versionHistory: {
        title: 'Historique des versions',
        empty: 'Aucune version publiee pour le moment.',
        ...
        publishSuccess: 'Nouvelle version publiee',
        rollbackButton: 'Restaurer',
        rollbackConfirmTitle: 'Restaurer la version {version}',
        rollbackConfirmBody:
          'Ceci remplace la definition et les entrees actuelles du reglement par l instantane de {version}. Les tournois deja rattaches a une autre version ne sont pas affectes.',
        rollbackConfirmAction: 'Restaurer',
        rollbackError: 'Echec de la restauration',
    ...
    weapons: {
      ...
      deleteBody:
        'Supprimer definitivement "{name}". {count} profil(s) de combattant y font reference et perdront le lien. Action irreversible — desactivez plutot pour la masquer des selecteurs.',
      cancel: 'Annuler',
    ...
    globalProfiles: {
      ...
      description: 'Gerer les profils de combattants, arbitres et participants ateliers.',
      csvImport: 'Import CSV',
      tabs: {
        profiles: 'Profils',
      ...
      merge: {
        ...
        selectSourceFirst: 'Selectionnez d abord un combattant source',
    ...
    systemVersions: {
      ...
      tls: {
        ...
        loadError: 'Echec du chargement du statut des certificats.',
        checkedAt: 'Verifie a',
        ...
        actions: {
          ...
          confirmForceRenewDescription:
            "Cela redemarre Traefik et interrompt brievement le HTTPS (~1-3s) sur tous les sous-domaines pendant la nouvelle tentative de renouvellement Let's Encrypt. Continuer ?",
          forceRenew: 'Forcer le renouvellement',
          renewSuccess: 'Traefik redemarre ; renouvellement relance.',
          renewFailed: 'Echec du renouvellement : {message}',
        },
      },
      host: {
        title: 'Machine hôte',
        description:
          "Identité et capacité du serveur sur lequel tourne l'ensemble de la plateforme.",
        refresh: 'Actualiser',
        refreshing: 'Actualisation...',
      ...
      runtimeHealth: {
        ...
        description: 'Etat en direct de la base, de Redis, des files et du disque.',
        recheck: 'Actualiser',
        rechecking: 'Actualisation...',
        checkedAt: 'Verifie a',
        loadError: "Impossible de charger l'etat du systeme.",
        ...
        db: {
          ...
          longestQuery: 'Requete la plus longue',
          cacheHit: 'Cache',
        ...
        settings: {
          ...
          checkInterval: 'Verifier toutes les (minutes)',
          cooldown: 'Delai entre e-mails (minutes)',
          ...
          save: 'Enregistrer',
          saved: "Parametres d'alerte enregistres.",
