...
export const en = {
  ...
  admin: {
    ...
    rulesets: {
      ...
      systemPanelAfterblowWindow: 'Afterblow window (ms)',
...
export const fr = {
  ...
  admin: {
    ...
    rulesets: {
      ...
      systemPanelAfterblowWindow: 'Fenetre afterblow (ms)',
  ...
  organizer: {
    ...
    phaseVisibility: {
      ...
      podiumGold: 'Champion',
      podiumSilver: 'Finaliste',
      podiumBronze: 'Bronze',
      podiumFourth: '4e place',
