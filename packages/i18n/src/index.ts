  ...
  publicApp: {
    ...
    eventHome: {
      ...
      cta: {
        ...
        imAParticipant: "I'm a participant →",
      },
    },
    home: {
    ...
    onboarding: {
      welcome: 'Welcome',
      findYourself: 'Find yourself in the participant list to get started.',
      sessionFailed: 'Failed to create session',
      networkError: 'Network error. Please try again.',
      youSelected: 'You selected',
      isThisYouPrefix: 'Is this you? Tap',
      isThisYouSuffix: 'to continue.',
      ...
      linkSendError: 'Could not send link. Try again later.',
      persona: {
        title: 'How are you here today?',
        subtitle: 'Select all that apply. You can change this later.',
        competitor: 'Competitor',
        competitorSub: "I'm fighting in this event",
        referee: 'Referee',
        refereeSub: "I'm officiating matches",
        workshopAttendee: 'Workshop Attendee',
        workshopAttendeeSub: "I'm attending workshops",
        accompanist: 'Accompanist',
        accompanistSub: "I'm here to support someone",
        public: 'Public',
        publicSub: "I'm watching the event",
        hintNote:
          'These are hints to personalise your experience. Your actual access is determined by your registrations and qualifications.',
        saving: 'Saving…',
        skipForNow: 'Skip for now',
        continue: 'Continue →',
        loginLinkSent: '✓ Login link sent to your registered email.',
        accessAnyDevice: 'Want to access your account from any device?',
    ...
    mySchedule: {
      ...
      findYourself: 'Find yourself in the participant list →',
      title: 'My Schedule',
      showAll: 'Show all',
  ...
  organizer: {
    ...
    eventStats: {
      ...
      detail: {
        ...
        colRatio: 'Ratio',
        caption:
          '✓ = landed the first strike · ✗ = received it · 1/2 = target value · -1 = with afterblow.',
      },
      referees: {
  ...
  publicApp: {
    ...
    eventHome: {
      ...
      cta: {
        ...
        participantPrompt:
          'Vous participez ? Retrouvez-vous dans la liste pour une vue personnalisée.',
        imAParticipant: 'Je suis participant →',
      },
    },
    home: {
    ...
    personLookup: {
      ...
      searchPlaceholder: 'Saisissez votre nom…',
    ...
    onboarding: {
      welcome: 'Bienvenue',
      findYourself: 'Retrouvez-vous dans la liste des participants pour commencer.',
      sessionFailed: 'Échec de la création de la session',
      networkError: 'Erreur réseau. Veuillez réessayer.',
      youSelected: 'Vous avez sélectionné',
      isThisYouPrefix: "C'est bien vous ? Touchez",
      isThisYouSuffix: 'pour continuer.',
      yesThatsMe: "Oui, c'est moi",
      settingUp: 'Configuration…',
      searchAgain: '← Rechercher à nouveau',
      notInListBody:
        "Seules les personnes pré-inscrites par l'organisateur peuvent utiliser cette application. Si vous devriez figurer dans la liste, adressez-vous à un organisateur à l'accueil.",
      trySearchingAgain: '← Réessayer la recherche',
      linkSendError: "Impossible d'envoyer le lien. Réessayez plus tard.",
      persona: {
        title: "Que faites-vous ici aujourd'hui ?",
        subtitle: "Sélectionnez tout ce qui s'applique. Vous pourrez modifier cela plus tard.",
        competitor: 'Compétiteur',
        competitorSub: 'Je combats dans cet événement',
        referee: 'Arbitre',
        refereeSub: "J'arbitre des matchs",
        workshopAttendee: 'Participant aux ateliers',
        workshopAttendeeSub: 'Je participe à des ateliers',
        accompanist: 'Accompagnateur',
        accompanistSub: "Je suis là pour soutenir quelqu'un",
        public: 'Public',
        publicSub: "Je regarde l'événement",
        hintNote:
          'Ce sont des indications pour personnaliser votre expérience. Votre accès réel dépend de vos inscriptions et qualifications.',
        saving: 'Enregistrement…',
        skipForNow: "Ignorer pour l'instant",
        continue: 'Continuer →',
        loginLinkSent: '✓ Lien de connexion envoyé à votre adresse e-mail enregistrée.',
        accessAnyDevice: "Vous voulez accéder à votre compte depuis n'importe quel appareil ?",
        sendLoginLink: 'Envoyez-moi un lien de connexion',
      },
    },
    mySchedule: {
      tbd: 'À définir',
      ...
      findYourself: 'Retrouvez-vous dans la liste des participants →',
      title: 'Mon planning',
  ...
  organizer: {
    ...
    eventStats: {
      ...
      detail: {
        ...
        colRatio: 'Ratio',
        caption:
          "✓ = a porte la premiere touche · ✗ = l'a recue · 1/2 = valeur de cible · -1 = avec afterblow.",
      },
      referees: {
