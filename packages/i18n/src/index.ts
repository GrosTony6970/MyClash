...
export const en = {
  ...
  admin: {
    ...
    rulesets: {
      ...
      rejectAction: 'Reject',
      confirmDelete: 'Delete this ruleset? This cannot be undone.',
      ...
      league: {
        ...
        archiveError: 'Could not archive scoring system',
        cloneError: 'Could not clone scoring system',
        restoreError: 'Could not restore scoring system',
        columns: {
          code: 'Code',
          name: 'Name',
          points: '1st / 8th / 16th',
        ...
        bulk: {
          ...
          selectAllAria: 'Select all archivable rows',
          archiveSelected: 'Archive selected',
          countLabel: '{n} selected',
        },
        confirm: {
          archiveTitle: 'Archive scoring system',
          archiveBody:
            'Archive "{name}"? It will be hidden from new leagues. Cannot be undone if any league still references the code.',
          archiveAction: 'Archive',
          bulkArchiveTitle: 'Archive {n} scoring systems?',
          bulkArchiveBody:
            'Each one will be hidden from new leagues. Per-row failures (e.g. a row referenced by a league) will surface as toasts; remaining rows continue.',
        ...
        toast: {
          ...
          bulkArchived: 'Archived {n} scoring systems ({failed} failed)',
        ...
        form: {
          ...
          editTitle: 'Edit "{name}"',
          builtinSubtitle:
            'This is a built-in preset and is read-only. Clone it to derive a variant.',
          editSubtitle: 'Rank → points table and tie-breaker ordering. Reusable across leagues.',
          cloneToEditButton: 'Clone to edit',
          backButton: '← Back',
          nameLabel: 'Name',
          codeLabel: 'Code',
...
export const fr = {
  ...
  admin: {
    ...
    rulesets: {
      ...
      confirmDelete: 'Supprimer ce ruleset ? Cette action est irreversible.',
      ...
      league: {
        ...
        showArchivedToggle: 'Afficher archives',
        ...
        archiveError: "Impossible d'archiver",
        ...
        bulk: {
          ...
          archiveSelected: 'Archiver selection',
          countLabel: '{n} selectionnes',
        },
        confirm: {
          archiveTitle: 'Archiver le systeme',
          archiveBody:
            'Archiver "{name}" ? Il sera masque des nouvelles ligues. Irreversible si une ligue reference encore le code.',
          archiveAction: 'Archiver',
          bulkArchiveTitle: 'Archiver {n} systemes ?',
          bulkArchiveBody:
            'Chacun sera masque des nouvelles ligues. Les echecs (ex. ligne reference par une ligue) seront signales en toasts ; les autres continuent.',
          bulkArchiveAction: 'Tout archiver',
        },
        toast: {
          cloned: 'Clone "{name}"',
          archived: 'Archive "{name}"',
          restored: 'Restaure "{name}"',
          bulkArchived: '{n} systemes archives ({failed} echecs)',
        ...
        form: {
          ...
          builtinSubtitle: 'Preset integre, lecture seule. Clonez-le pour creer une variante.',
          editSubtitle: 'Bareme rang -> points et ordre des departages. Reutilisable.',
          cloneToEditButton: 'Cloner pour editer',
          backButton: '← Retour',
          nameLabel: 'Nom',
          codeLabel: 'Code',
