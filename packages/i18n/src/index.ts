  ...
  organizer: {
    ...
    staff: {
      ...
      tabHint: {
        ...
        checkin:
          "Tient la table d'accueil et enregistre les arrivées des tireurs. Aucune affectation de lice.",
    ...
    hemaRatings: {
      ...
      description:
        "Génère les fichiers CSV attendus par hemaratings.com : un fighters.csv, un clubs.csv et un fichier par tournoi. Vérifiez les alertes ci-dessous avant d'envoyer — HEMA Ratings identifie les tireurs par leur nom, donc une faute d'orthographe crée un doublon.",
      uploadHint:
      ...
      fighterFinderHint:
        'Recherchez les tireurs dans leur FighterFinder 5000 pour compléter les identifiants manquants.',
      fighterFinderLink: 'Ouvrir FighterFinder 5000',
      warnings: {
        fighter_missing_hema_id:
          'Tireurs sans identifiant HEMA Ratings — ils seront identifiés par leur nom seul',
        fighter_missing_nationality: 'Tireurs sans nationalité',
        club_missing_country: 'Clubs sans code pays',
        duplicate_fighter_name:
          'Tireurs dont les noms se confondent — HEMA Ratings les fusionnera en une seule fiche',
