  ...
  organizer: {
    ...
    refereesPage: {
      ...
      catalogDeleteConfirm:
        'Delete this skill? Custom skills only — system skills cannot be deleted.',
...
export const fr = {
  ...
  organizer: {
    ...
    refereesPage: {
      ...
      catalogDeleteConfirm:
        'Supprimer cette competence ? Personnalisees uniquement — les competences systeme sont protegees.',
