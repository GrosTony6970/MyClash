...
export const en = {
  ...
  publicApp: {
    ...
    me: {
      ...
      instructor: {
        ...
        notScheduled: 'Not scheduled yet',
        sessionsSingular: '{count} session',
        ...
        feedback: 'Feedback',
        feedbackAverage: 'Average rating',
      ...
      groups: {
        ...
        updateError: 'Could not update the group.',
      ...
      hub: {
        ...
        nextUp: 'Next up',
        nextUpEvent: 'Next up · this event',
      ...
      workshops: {
        ...
        loadError: 'Could not load workshops.',
    ...
    following: {
      ...
      resultWin: 'W',
      resultLoss: 'L',
      liveNowAtLice: 'Live now · {name}',
      nextBadge: 'Next: {label} · {time}',
      justFinished: 'Just finished {red}–{blue}',
      loginLinkSent: '✓ Login link sent to your email.',
      guestCta: 'Get push notifications when your favorites fight.',
    ...
    live: {
      ...
      liceNotFoundBody: '“{name}” is not a known Lice for this event.',
      backToOverview: 'Back to overview',
      allPistes: 'All lices',
      piste: 'Lice',
    ...
    refereePublic: {
      dutiesTitle: 'My Referee Duties',
      mySchedule: 'My Schedule',
      noAssignments: 'No referee assignments yet. Check back once the organizer assigns referees.',
      ...
      backToDuties: 'Back to duties',
      refereeDuties: 'Referee duties',
      yourRole: 'Your role:',
      cornerRed: 'Red',
      cornerBlue: 'Blue',
      vs: 'VS',
      matchStatusHalted: 'Halted',
      issueWarning: 'Issue Warning',
      requestAttention: 'Request Attention',
      attentionMessage: 'Referee requests attention',
      scoringOversight: 'Scoring oversight',
      scoringOversightBody:
        'Monitor exchange entries on the scoring tablet. Use Request Attention if a correction is needed.',
      targetFighter: 'Target fighter',
      reason: 'Reason',
      noteOptional: 'Note (optional)',
      notePlaceholder: 'Additional details…',
      warningReasons: {
        unsportsmanlikeConduct: 'Unsportsmanlike conduct',
        illegalTechnique: 'Illegal technique',
        equipmentViolation: 'Equipment violation',
        excessiveForce: 'Excessive force',
        other: 'Other',
      },
    },
    mySchedule: {
  ...
  admin: {
    ...
    adminDesignReq: {
      ...
      tableDemoTfName: 'TF v1 (Tournoi de Frappe)',
    ...
    orgPools: {
      ...
      prngSeed: 'PRNG seed',
      poolsFightersSummary: '{pools} pools · {fighters} fighters',
      costLabel: 'Cost: {cost}',
      matchCount: '{count} matches',
      sameClubBadge: '⚠ club',
      savedToDatabase: '✓ Saved to database',
      regenerate: 'Regenerate',
      emptyStateHint: 'Configure above and click Generate to see a proposal.',
      fighterCount: '{count} fighters',
    },
    orgRefBracket: {
      availabilityAll: 'all',
    ...
    common: {
      ...
      removeApiKeyFailed: 'Failed to remove key',
...
export const fr = {
  ...
  publicApp: {
    ...
    me: {
      ...
      instructor: {
        ...
        sessionsSingular: '{count} séance',
        sessionsPlural: '{count} séances',
        accept: 'Accepter',
        refuse: 'Refuser',
      ...
      people: {
        ...
        follow: 'Suivre',
        following: 'Suivi',
        followingCount: 'Suivi ({count})',
        noUpcomingEvents: 'Aucun événement à venir',
        followError: 'Impossible de mettre à jour le suivi. Réessayez.',
      ...
      groups: {
        ...
        updateError: 'Impossible de mettre à jour le groupe.',
        loadError: 'Impossible de charger vos groupes.',
      ...
      events: {
        ...
        loadError: 'Impossible de charger vos événements.',
      },
      hub: {
        back: 'Mes événements',
        ...
        nextUp: 'À venir',
        nextUpEvent: 'À venir · cet événement',
    ...
    tournament: {
      ...
      finalRanking: {
        subtitle:
          'Placement au tableau — les tireurs éliminés au même tour sont départagés par leur score de poule.',
        colRank: 'Rang',
        colFighter: 'Combattant',
        colResult: 'Résultat',
    ...
    following: {
      ...
      resultWin: 'V',
      resultLoss: 'D',
      liveNowAtLice: 'En direct · {name}',
      nextBadge: 'À suivre : {label} · {time}',
      justFinished: 'Vient de terminer {red}–{blue}',
      loginLinkSent: '✓ Lien de connexion envoyé à votre adresse e-mail.',
      guestCta: 'Recevez des notifications push quand vos favoris combattent.',
    ...
    live: {
      ...
      liceNotFoundBody: "« {name} » n'est pas une lice connue pour cet événement.",
      ...
      liceEyebrow: 'Lice',
      nowPlaying: 'Assaut en cours',
    },
    refereePublic: {
      dutiesTitle: "Mes missions d'arbitrage",
      mySchedule: 'Mon planning',
      noAssignments:
        "Aucune affectation d'arbitrage pour le moment. Revenez une fois que l'organisateur aura désigné les arbitres.",
      statusAssigned: 'Affecté',
      statusConfirmed: 'Confirmé',
      statusDeclined: 'Refusé',
      confirm: 'Confirmer',
      decline: 'Refuser',
      matchNotFound: 'Assaut introuvable',
      backToDuties: 'Retour aux missions',
      refereeDuties: "Missions d'arbitrage",
      yourRole: 'Votre rôle :',
      cornerRed: 'Rouge',
      cornerBlue: 'Bleu',
      vs: 'VS',
      matchStatusHalted: 'Interrompu',
      issueWarning: 'Donner un avertissement',
      requestAttention: "Demander de l'attention",
      attentionMessage: "L'arbitre demande de l'attention",
      scoringOversight: 'Supervision du score',
      scoringOversightBody:
        "Surveillez la saisie des échanges sur la tablette de score. Utilisez « Demander de l'attention » si une correction est nécessaire.",
      targetFighter: 'Combattant visé',
      reason: 'Motif',
      noteOptional: 'Note (facultatif)',
      notePlaceholder: 'Détails supplémentaires…',
      warningReasons: {
        unsportsmanlikeConduct: 'Conduite antisportive',
        illegalTechnique: 'Technique interdite',
        equipmentViolation: "Infraction à l'équipement",
        excessiveForce: 'Force excessive',
        other: 'Autre',
      },
    },
    mySchedule: {
    ...
    tournamentStats: {
      ...
      colDoubles: 'Dbl',
      colDoublesTitle: 'Doubles',
      colClean1GivenTitle: 'Touche nette 1pt donnée',
      colAfterblow1GivenTitle: 'Riposte 1pt donnée',
      colClean2GivenTitle: 'Touche nette 2pts donnée',
      colAfterblow2GivenTitle: 'Riposte 2pts donnée',
      colClean1ReceivedTitle: 'Touche nette 1pt reçue',
      colAfterblow1ReceivedTitle: 'Riposte 1pt reçue (touche toujours comptée)',
      colClean2ReceivedTitle: 'Touche nette 2pts reçue',
      ...
      deepTargetsCount: 'Touches profondes',
  ...
  admin: {
    ...
    orgPools: {
      breadcrumbEvent: 'Événement',
      poolPopulator: 'Générateur de poules',
      backToPools: '← Poules',
      configuration: 'Configuration',
      sizeMode: 'Mode de taille',
      schoolSeparation: 'Séparation des clubs',
      skillBalance: 'Équilibrage du niveau',
      prngSeed: 'Graine PRNG',
      poolsFightersSummary: '{pools} poules · {fighters} tireurs',
      costLabel: 'Coût : {cost}',
      matchCount: '{count} assauts',
      sameClubBadge: '⚠ club',
      savedToDatabase: '✓ Enregistré en base',
      regenerate: 'Régénérer',
      emptyStateHint: 'Configurez ci-dessus puis cliquez sur Générer pour voir une proposition.',
    ...
    orgTournaments: {
      ...
      remove: 'Supprimer',
      addCleanButton: '+ Ajouter un bouton touche nette',
    ...
    common: {
      ...
      removeApiKeyFailed: 'Échec de la suppression de la clé',
      ...
      saveApiKeyFailed: "Échec de l'enregistrement de la clé API",
  ...
  organizer: {
    ...
    tournaments: {
      ...
      settings: {
        ...
        cleanButtons: 'Nom du bouton coup net',
    ...
    eventStats: {
      ...
      detail: {
        ...
        colTotal: 'Total',
        colDoublePct: '% Dbl',
        colDoublePctTitle: 'Part des echanges de ce tireur qui etaient des doubles',
        colRatio: 'Ratio de touches',
        caption:
    ...
    matchDetail: {
      ...
      exClean: 'Touche nette — {color} +{value}',
      exAfterblow: 'Afterblow — {color} +{striker} / afterblow +{defender}',
      exDouble: 'Double',
