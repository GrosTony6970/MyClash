  ...
  admin: {
    ...
    organizations: {
      ...
      detail: {
        ...
        protectedNote:
          'MyClash HQ is the bootstrap super-admin organization and cannot be deleted.',
  ...
  admin: {
    ...
    organizations: {
      ...
      detail: {
        ...
        protectedNote:
          "MyClash HQ est l'organisation bootstrap du super-admin et ne peut pas etre supprimee.",
