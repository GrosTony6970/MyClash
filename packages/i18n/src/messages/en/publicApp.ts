...
export const publicApp = {
  ...
  following: {
    signInToFollow: 'Sign in to follow someone.',
    followUpdateError: 'Could not update follow. Try again.',
    roleCompetitor: 'Competitor',
    roleReferee: 'Referee',
    roleInstructor: 'Instructor',
    personNotFound: 'Person not found',
    personLoadError: 'Could not load this person. Try again.',
    followButton: 'Follow',
  ...
  tournamentStats: {
    ...
    colCleanGivenTitle: 'Clean hits landed at this target value',
    colAfterblowGivenTitle: 'First strikes landed at this target value that drew an afterblow',
    colCleanReceivedTitle: 'Clean hits received at this target value',
    colAfterblowReceivedTitle:
      'First strikes received at this target value where an afterblow followed (blow always counted)',
    colTotal: 'Tot',
