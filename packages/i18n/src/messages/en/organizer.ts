...
export const organizer = {
  ...
  schedulePage: {
    ...
    editPopover: {
      ...
      licesLabel: 'Lices',
      boutLengthLabel: 'Match length (min)',
      boutLengthHint: "Whole minutes, 1 to {max}. Leave it blank to use the planner's length.",
      startUnreadable: 'The start time could not be read. Use HH:MM, for example 09:30.',
      cancel: 'Cancel',
      save: 'Save',
    },
    blockGrid: {
    ...
    planner: {
      ...
      config: {
        ...
        perTournament: {
          ...
          blankMeansEvent: "Leave a box blank to use the Event's value.",
          pool: 'Pool',
          swiss: 'Swiss',
          elimination: 'Elim.',
          finals: 'Finals',
          ...
          rest: 'Rest',
          restAria: 'Rest break for {tournament}, in minutes. Zero is no break.',
        },
      },
      sheetLoadFailed:
