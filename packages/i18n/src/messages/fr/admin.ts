...
export const admin = {
  ...
  organizations: {
    ...
    create: {
      ...
      description: 'Cree l espace organisateur et rattache un compte responsable en une operation.',
    ...
    edit: {
      ...
      description: 'Changer le nom ou le slug. Les changements de statut se font depuis le detail.',
      save: 'Enregistrer',
      saving: 'Enregistrement...',
      cancel: 'Annuler',
  ...
  reviewQueue: {
    ...
    approveConfirmDeletion: 'Cela supprimera definitivement la cible et toutes ses donnees liees.',
    approveTypeDelete: 'Tapez DELETE pour confirmer',
    rejectModalTitle: 'Refuser la demande',
    rejectReasonLabel: 'Raison du refus',
    rejectReasonPlaceholder: 'Expliquez pourquoi cette demande est refusee (10-500 caracteres)...',
