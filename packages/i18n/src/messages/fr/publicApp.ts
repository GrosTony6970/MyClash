...
export const publicApp = {
  ...
  meSettings: {
    title: 'Parametres',
    subtitle: 'Gerez la facon dont MyClash vous notifie, ce que les autres voient et votre compte.',
    ai: {
    ...
    notif: {
      ...
      scheduleChangesDescription: 'Etre notifie quand vos horaires de match ou d atelier changent.',
