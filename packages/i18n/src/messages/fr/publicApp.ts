...
export const publicApp = {
  ...
  following: {
    signInToFollow: "Connectez-vous pour suivre quelqu'un.",
    followUpdateError: 'Impossible de mettre à jour le suivi. Réessayez.',
    roleCompetitor: 'Compétiteur',
    roleReferee: 'Arbitre',
    roleInstructor: 'Instructeur',
    personNotFound: 'Personne introuvable',
    personLoadError: 'Impossible de charger cette personne. Réessayez.',
    followButton: 'Suivre',
  ...
  tournamentStats: {
    ...
    colCleanGivenTitle: 'Touches propres portées à cette valeur de cible',
    colAfterblowGivenTitle:
      'Premières touches portées à cette valeur de cible suivies d’une riposte',
    colCleanReceivedTitle: 'Touches propres reçues à cette valeur de cible',
    colAfterblowReceivedTitle:
      'Premières touches reçues à cette valeur de cible suivies d’une riposte (touche toujours comptée)',
    colTotal: 'Tôt',
