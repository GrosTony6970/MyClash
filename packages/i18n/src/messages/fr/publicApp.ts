...
export const publicApp = {
  ...
  home: {
    ...
    title: 'Suivez les événements AMHE en direct depuis votre telephone.',
    subtitle:
      'Ouvrez un événement pour consulter le planning live, trouver des participants, suivre des combattants et voir les résultats publies.',
    openEvent: 'Ouvrir',
    ...
    unavailableDescription:
      'Réessayez dans un instant, ou ouvrez un lien événement partage par un organisateur.',
  },
  login: {
  ...
  fighterProfile: {
    ...
    refereeDashboardDescription:
      'Consultez votre activite arbitre, les cartons distribues, vos rôles et vos partenaires reguliers.',
  ...
  meSettings: {
    ...
    ai: {
      ...
      subtitle:
        'Ajoutez votre propre cle de fournisseur IA pour générer un bilan de performance personnalise. La cle est chiffree et utilisée uniquement pour vos bilans.',
      keys: {
        title: 'Vos cles API',
        ...
        empty: 'Aucune cle. Ajoutez-en une pour générer vos bilans.',
  ...
  notifications: {
    ...
    statusGranted: 'Les notifications sont autorisees mais pas activées sur cet appareil.',
    statusNeedsPermission: 'Les notifications doivent être autorisees avant activation.',
    enabled: 'Active',
    off: 'Inactive',
    enabling: 'Activation...',
