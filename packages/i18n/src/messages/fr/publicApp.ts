...
export const publicApp = {
  ...
  home: {
    ...
    tabsLabel: 'Basculer entre événements, ligues et combattants',
    tabEvents: 'Événements',
    tabLeagues: 'Ligues',
    tabFighters: 'Combattants',
  ...
  fighters: {
    metaTitle: 'Annuaire des combattants',
    metaDescription: 'Parcourez les combattants qui participent aux événements AMHE sur MyClash.',
    title: 'Annuaire des combattants',
    subtitle:
      'Les combattants inscrits sur MyClash qui ont choisi d’apparaître. Recherchez par nom ou par club.',
    filtersLabel: 'Filtrer l’annuaire',
    filtersToggle: 'Filtres',
    searchLabel: 'Rechercher un combattant',
    searchPlaceholder: 'Rechercher par nom ou club',
    clubPlaceholder: 'Filtrer par club',
    weaponAny: 'Toutes les armes',
    resultCount: '{count} combattants',
    colName: 'Nom',
    colClub: 'Club',
    colCountry: 'Pays',
    colWeapons: 'Armes',
    ...
    empty: 'Aucun combattant n’est encore listé.',
    emptyHint:
      'Les combattants apparaissent ici dès qu’ils s’inscrivent et choisissent d’être listés.',
    emptyForQuery: 'Aucun combattant ne correspond à ces filtres.',
    previous: 'Précédent',
    next: 'Suivant',
    browseCta: 'Tous les combattants →',
    loadError: 'Impossible de charger l’annuaire des combattants.',
  },
  organisers: {
