...
export const organizer = {
  ...
  venues: {
    ...
    licesSection: 'Pistes',
    licesHelp:
      'Définissez les pistes de ce lieu une fois. Les nouveaux evenements a ce lieu pre-remplissent leurs pistes a partir d’ici.',
    addLice: 'Ajouter',
    ...
    eventsHelp:
      'Rattachez ce lieu a un ou plusieurs evenements. Un lieu ne peut pas être detache d un evenement tant qu il y a des matchs ou des sessions d atelier.',
    eventsBlocked:
  ...
  shell: {
    ...
    eventSwitcher: {
      ...
      loadFailed: 'Échec du chargement des evenements',
      manageAll: 'Gérer tous les evenements...',
    },
    nav: {
  ...
  dashboard: {
    manageEvents: 'Gérer les evenements',
    brand: {
      ...
      colorHelp:
        'Utilisée comme bande d accent sur le bord gauche de chaque carte d evenement sur la page d accueil publique.',
      previewLabel: 'Aperçu',
    ...
    emptyTitle: 'Créez votre premier evenement',
    emptyDescription:
      'Un evenement est le rassemblement - FAL 2026, Swordfish 2027. Dedans, vous créez les tournois, les stages et le roster.',
    noLocation: 'Aucun lieu pour le moment',
    metrics: {
      eventsCreated: 'Evenements créés',
      ...
      fightersDetail: 'Inscriptions comptées par evenement',
      referees: 'Participations arbitres',
      refereesDetail: 'Qualifications actives comptées par evenement',
    },
  },
  events: {
    eyebrow: 'Gestion des evenements',
    create: 'Créer un evenement',
    ...
    venuesSection: 'Lieux',
    venuesHelp:
      'Choisissez le ou les lieux de cet evenement. Les lieux de tournoi y injectent leurs pistes ; un lieu ne peut pas être retire tant qu’il a des assauts programmes ou des sessions de stage.',
    venuesBlocked: 'Enregistre. Ces lieux sont encore utilises et ont ete conserves : {venues}.',
    deleteTitle: 'Suppression définitive',
    deleteWarning:
      'Cette action supprime définitivement "{name}" et ses données. Archiver est plus sur pour un evenement reel.',
    ...
    visibilityLocked: 'Les evenements {status} ne peuvent pas être bascules ici.',
  ...
  clockReport: {
    ...
    noStaff: 'Aucune tablette de saisie configurée pour cet evenement.',
  ...
  readiness: {
    ...
    allClear: 'Rien en attente. Cet evenement est prêt a tourner.',
  ...
  tournaments: {
    ...
    emptyDescription:
      'Un tournoi est une compétition au sein de cet evenement - épée longue, messer, sabre, etc. Ajoutez-en un pour commencer a gérer les poules, le tableau et les inscriptions.',
  ...
  newEvent: {
    ...
    backToOrg: '{slug}',
    stepsLabel: "Etapes de création de l'evenement",
    steps: {
      basics: 'Bases',
      lices: 'Lieu',
    ...
    logoPreviewAlt: 'Aperçu du logo evenement',
    ...
    validation: {
      ...
      createFailed: "Impossible de créer l'evenement",
  ...
  eventCompensation: {
    ...
    amount: 'Montant',
    paid: 'Paye',
    empty: 'Aucune affectation arbitre trouvée pour cet evenement.',
  ...
  swiss: {
    ...
    configure: {
      ...
      roundCountHelp:
        "Chaque combattant dispute ce nombre de rondes. En dessous de trois le classement n'a pas de sens ; au-dessus de neuf un evenement d'une journée manque de temps.",
  ...
  deletionRequest: {
    ...
    autoArchiveNotice:
      'En envoyant, cet evenement sera archive et une demande de suppression sera envoyée aux admins MyClash pour revue.',
    permanentDeleteWarning:
      'Une fois approuve par un super-admin, cet evenement est définitivement supprime. Ses matchs et résultats ne seront PAS conserves et seront exclus des statistiques, classements et historiques des combattants.',
  ...
  staffing: {
    tournamentLabel: 'Tournoi',
    eventDefault: "Défaut de l'evenement",
    ...
    inheritingExplanation:
      "Ce tournoi herite du défaut de l'evenement. Activez 'Surcharger pour ce tournoi' pour editer.",
    resetToEventDefault: "Réinitialiser au défaut de l'evenement",
    resetError: 'Impossible de réinitialiser.',
    resetDone: "Reinitialise au défaut de l'evenement.",
  ...
  refereesPage: {
    ...
    tabIntros: {
      ...
      qualifications:
        'Définissez les competences disponibles pour cet evenement et qui possede chaque competence — Declarant, Assesseur, Table, ou toute competence personnalisée.',
      staffing:
    ...
    clearAllConfirm:
      'Effacer toutes les affectations arbitres de cet evenement ? Action irréversible.',
