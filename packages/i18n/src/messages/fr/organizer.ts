...
export const organizer = {
  ...
  venues: {
    title: 'Lieux',
    description:
      'Lieux physiques utilises par votre organisation. Un lieu peut accueillir tournois, ateliers, ou les deux. Subdivisez en zones pour plusieurs ateliers en parallèle.',
    ...
    areasSection: 'Zones',
    areasHelp:
      'Subdivisez ce lieu en au moins deux zones nommées pour accueillir plusieurs ateliers en parallèle. Inutile si une seule zone suffit.',
    addArea: 'Ajouter',
    newAreaPlaceholder: 'Tapis 1',
    removeArea: 'Retirer',
    licesSection: 'Pistes',
    licesHelp:
      'Définissez les pistes de ce lieu une fois. Les nouveaux événements à ce lieu pre-remplissent leurs pistes à partir d’ici.',
    addLice: 'Ajouter',
    ...
    eventsHelp:
      "Rattachez ce lieu à un ou plusieurs événements. Un lieu ne peut pas être detache d'un événement tant qu'il y a des matchs ou des sessions d'atelier.",
    eventsBlocked:
  ...
  leagues: {
    ...
    subtitle:
      'Parcourez les ligues et demandez à rejoindre. Les approbations sont gérées par le super-admin de la ligue.',
    ...
    emptyState: 'Aucune ligue publique à afficher.',
    memberBadge: 'Membre',
    pendingBadge: 'Examen en cours',
    messagePlaceholder: 'Message optionnel',
    requestToJoinButton: 'Demander à rejoindre',
    orgLoadError: "Impossible de charger l'organisation",
    leaguesLoadError: 'Impossible de charger les ligues',
    joinSuccessToast: 'Demande de rejoindre envoyée',
    joinFailedToast: 'Échec de la demande',
    withdrawSuccessToast: 'Demande retirée',
    withdrawFailedToast: 'Échec du retrait',
    tabDiscover: 'Découvrir et rejoindre',
    ...
    memberOnlyNote:
      "Votre organisation est membre de cette ligue. Contactez l'administrateur de la ligue pour la gérer.",
    attachments: {
      expand: 'Afficher les tournois rattaches',
      collapse: 'Masquer les tournois rattaches',
      empty: "Aucun tournoi de votre organisation n'est rattaché à cette ligue pour le moment.",
      groupLabel: 'Groupe',
      ...
      detachError: 'Impossible de mettre à jour le rattachement',
    },
    attach: {
      ...
      groupLabel: 'Groupe',
      submit: 'Rattacher',
      sent: 'Demande de rattachement envoyée',
      error: 'Impossible de demander le rattachement',
      alreadyRequested: '(demande)',
      alreadyAttached: '(rattache)',
      noTournaments: "Votre organisation n'a pas encore de tournoi à rattacher.",
    },
    manage: {
      tabManage: 'Gérer',
      listHeading: 'Ligues que vous gérez',
      listEmpty: 'Votre organisation ne gère aucune ligue pour le moment.',
      ...
      notFound: 'Ligue introuvable, ou vous ne la gérez pas.',
  ...
  shell: {
    ...
    eventEyebrow: 'Centre de commande événement',
    title: '{organization}',
    eventTitle: '{event}',
  ...
  penaltyReviews: {
    ...
    dismissedToast: 'Revision rejetée.',
    actionFailed: 'Impossible de mettre à jour la revision.',
    resolvedTitle: 'Traitées ({count})',
  ...
  orgSettings: {
    ...
    membersSubtitle: 'Qui peut accéder à cette organisation, et avec quel rôle.',
    ...
    addHint:
      'La personne doit déjà avoir un compte MyClash avec cet email. Le rôle owner ne peut être reattribue que par un super-admin.',
    unknownUser: 'Utilisateur inconnu',
  ...
  dashboard: {
    ...
    brand: {
      ...
      saveError: "Impossible de mettre à jour l'organisation.",
    },
    failedStats: 'Impossible de charger les indicateurs.',
    loadingStats: 'Chargement des indicateurs...',
    emptyTitle: 'Créez votre premier événement',
    emptyDescription:
      'Un événement est le rassemblement - FAL 2026, Swordfish 2027. Dedans, vous créez les tournois, les stages et le roster.',
    noLocation: 'Aucun lieu pour le moment',
    metrics: {
      eventsCreated: 'Événements créés',
      eventsCreatedDetail: 'Tous les événements de cette organisation',
      upcomingEvents: 'Événements à venir',
      upcomingEventsDetail: "Commencent aujourd'hui ou plus tard",
      tournaments: 'Tournois',
      tournamentsDetail: 'Dans tous les événements',
      fighters: 'Participations combattants',
      fightersDetail: 'Inscriptions comptées par événement',
      referees: 'Participations arbitres',
      refereesDetail: 'Qualifications actives comptées par événement',
    },
  },
  events: {
    eyebrow: 'Gestion des événements',
    ...
    eventKindHelp:
      'Les événements de test sont masques des pages publiques, des espaces personnels et des statistiques. Les événements de club sont publics mais ne comptent jamais pour les classements, les statistiques de carriere ni HEMA Ratings. Les deux peuvent être supprimes définitivement même avec des résultats enregistres.',
    kinds: {
      standard: 'Événement standard',
      test: 'Événement de test',
      club: 'Événement de club',
    },
    testBadge: 'Test',
    ...
    publishCta: 'Publier',
    statusHelp:
      "Modifiez le statut pour passer l'événement en cours, termine, ou le repasser en brouillon. Enregistre avec le reste du formulaire.",
    statuses: {
      draft: 'Brouillon',
      published: 'Publie',
      running: 'En cours',
    ...
    saveError: "Impossible de mettre à jour l'événement.",
    archiveError: "Impossible d'archiver l'événement.",
    unpublish: 'Repasser en brouillon',
    published: "L'événement est publié.",
    unpublished: "L'événement est repasse en brouillon.",
    visibilityError: "Impossible de changer la visibilité de l'événement.",
    deleted: 'Événement supprime.',
    ...
    venuesSection: 'Lieux',
    venuesHelp:
      'Choisissez le ou les lieux de cet événement. Les lieux de tournoi y injectent leurs pistes ; un lieu ne peut pas être retire tant qu’il a des assauts programmes ou des sessions de stage.',
    venuesBlocked: 'Enregistre. Ces lieux sont encore utilises et ont été conserves : {venues}.',
    deleteTitle: 'Suppression définitive',
    deleteWarning:
      'Cette action supprime définitivement "{name}" et ses données. Archiver est plus sur pour un événement reel.',
  ...
  clockReport: {
    ...
    subtitle: 'Si les horaires enregistres pour cet événement sont fiables.',
    loading: 'Vérification des tablettes...',
    loadError: 'Impossible de charger le rapport horloge.',
    noStaff: 'Aucune tablette de saisie configurée pour cet événement.',
    allClear: 'Toutes les tablettes ont annonce une horloge dans la tolerance.',
    needsAttention: '{count} tablette(s) à vérifier.',
    measured: 'Horloge {skew} par rapport au serveur - {exchanges} touche(s) enregistrée(s).',
    syncLag:
      "La touche la plus lente a mis {lag} à atteindre le serveur. C'est la file d'attente qui fonctionne, pas un problème d'horloge.",
    outOfEnvelope: '{count} touche(s) horodatée(s) en dehors de leur propre assaut.',
    confidence: {
      ok: 'Fiable',
      skewed: 'Horloge décalée',
      unmeasured: 'Non mesurée',
    },
  },
  debrief: {
    navLabel: 'Débriefing',
  ...
  startOfDay: {
    ...
    stageClear: 'OK',
    stageOutstanding: '{count} à faire',
    stageEmpty:
      "Rien à vérifier ici pour l'instant - en général parce que l'étape précédente n'est pas terminée.",
    stage: {
  ...
  readiness: {
    ...
    allClear: 'Rien en attente. Cet événement est prêt à tourner.',
    outstanding: '{count} point(s) demandent encore votre attention.',
    eventLevel: 'Événement',
    fix: 'Corriger',
    view: 'Voir',
    level: {
      ok: 'Prêt',
    ...
    publishTitle: 'Publier avant que tout soit prêt ?',
    publishDescription:
      '{count} point(s) restent en attente. Publier reste possible - ceci sert juste à éviter les mauvaises surprises.',
    publishAnyway: 'Publier quand même',
    publishHint:
      "Publier ouvre l'événement sur le site public. Vous pourrez continuer à travailler sur ces points ensuite.",
    check: {
      tournaments: {
        label: 'Tournois',
        ok: '{count} tournoi(s) créés.',
        critical: 'Aucun tournoi - un événement en demande au moins un pour tourner.',
      },
      pistes: {
        label: 'Pistes',
        ok: '{count} piste(s) configurées.',
      ...
      ruleset: {
        ...
        warn: 'Aucun règlement de score fixe. Les matchs utiliseront celui par défaut.',
      },
      fighters: {
        label: 'Combattants',
        ok: '{count} combattant(s) inscrits.',
        critical:
          '{count} combattant(s) inscrits. Il en faut au moins 2 pour générer les poules et le tableau.',
      },
      format: {
        label: 'Format',
        warn: "Ni poules ni tableau générés - ce tournoi n'a pas encore de format.",
      },
      pools: {
        label: 'Poules',
        ok: '{count} poule(s) générées.',
        warn: "La phase de poules existe mais aucune poule n'a été générée.",
      ...
      swissRounds: {
        ...
        info: '{rounds} ronde(s) appariée(s). La suivante se tire seule des que la courante se termine.',
      },
      bracket: {
        label: 'Tableau',
        info: 'Se remplit depuis le classement des poules une fois celles-ci terminées - en général le deuxieme jour. Rien à faire pour le moment.',
      },
      rosterIdentity: {
        label: 'Identités des combattants',
        ok: 'Les {total} combattants inscrits sont relies à un profil MyClash.',
        warn: "{missing} des {total} combattants inscrits ne sont relies à aucun profil. Leurs résultats n'atteindront ni leur page de carriere ni aucun classement de ligue.",
      },
      rosterClub: {
        label: 'Clubs',
  ...
  tournaments: {
    title: 'Tournois',
    description: 'Gérez les tournois de {event}.',
    create: 'Créer un tournoi',
    edit: 'Modifier',
    archive: 'Archiver',
    hardDelete: 'Supprimer',
    status: 'Statut',
    saveError: 'Impossible de mettre à jour le tournoi.',
    ...
    loadError: 'Échec du chargement des tournois.',
    ...
    wizard: {
      ...
      weapon: 'Arme',
      ruleset: 'Règlement',
      penaltyRuleset: 'Règlement de pénalités',
      recommended: 'Recommande',
      penaltyRulesetBlankHint:
        'Aucun règlement choisi — le défaut integre FFAMHE v2026 sera applique.',
      nameRequired: 'Le nom est obligatoire.',
      publishOnFinish: 'Publier à la fin',
      finish: 'Terminer',
    ...
    settings: {
      ...
      backToList: 'Retour à la liste des tournois',
      basics: 'Bases',
      matchFormat: 'Format des matchs',
      display: 'Affichage',
      advanced: 'Avance',
      ...
      recap: 'Recap',
      drift: {
        title: 'Les règles effectives ont changé depuis le dernier enregistrement',
        body: "Les règles de score ou de penalite en vigueur pour ce tournoi ne correspondent plus à l'empreinte enregistrée lors de la dernière configuration — le plus souvent parce qu'une regle de la plateforme (comme le barème de pénalités integre) a été modifiée. Confirmez pour mettre à jour l'empreinte après avoir verifie les paramètres actuels.",
        acknowledge: 'Confirmer',
        acknowledged: 'Empreinte du barème mise à jour.',
        acknowledgeError: "Impossible de mettre à jour l'empreinte. Veuillez réessayer.",
      },
      lockHelp: {
        intro:
          'Verrouille les poules ou tableaux termines après un délai pour empecher les arbitres de continuer à les modifier. Reglage au niveau du tournoi, distinct du barème.',
        lockedNote:
        ...
        delayHelp:
          "Délai de grace après la fin du dernier assaut d'une poule ou d'un tableau avant le verrouillage — laisse le temps de corriger. 0 verrouille des la fin.",
        completedPools: 'Verrouiller les poules terminées',
        completedPoolsHelp:
          "Quand tous les assauts d'une poule sont termines, verrouille cette poule après le délai. Uniquement si le verrouillage auto est active.",
        completedBrackets: 'Verrouiller les tableaux termines',
        completedBracketsHelp:
          "Quand tous les assauts d'un tableau sont termines, verrouille ce tableau après le délai. Uniquement si le verrouillage auto est active.",
      },
      venues: 'Lieux',
      name: 'Nom',
      slug: 'Slug URL',
      slugLocked: 'Le slug est verrouillé après la création.',
      weapon: 'Arme',
      ruleset: 'Règlement',
      penaltyRuleset: 'Règlement de pénalités',
      ...
      timePool: 'Durée des poules',
      timeBracket: 'Durée des brackets',
      timeFinals: 'Durée des finales',
      ...
      scoringReverse: 'Inverse (zéro perd)',
      pointCapHelp:
        'Le premier combattant à atteindre ce score gagne; le match se termine alors automatiquement.',
      timerModeHelp:
      ...
      scoringDirectionHelp:
        "Normal : les points s'additionnent; le premier au plafond gagne. Inverse (zéro perd) : chaque combattant part du plafond et perd des points; le premier à atteindre 0 perd.",
      ...
      colorHelp:
        "Optionnel. Affiche un petit point à cote du nom du tournoi dans l'interface (calendrier, poules, tableau, inscriptions).",
      ...
      logoRemove: 'Retirer',
      logoUploading: 'Envoi en cours…',
      logoPreviewAlt: 'Aperçu du logo du tournoi',
      save: 'Enregistrer',
      saved: 'Enregistre.',
    },
    venuesEditor: {
      title: 'Lieux',
      help: 'Définissez le lieu de chaque phase. Les poules et le tableau peuvent se derouler dans des lieux differents.',
      pools: 'Lieu des poules',
      bracket: 'Lieu du tableau',
      none: 'Non attribue',
      empty:
        "Aucun lieu n'est rattaché à cet événement. Ajoutez des lieux à l'événement avant de les attribuer ici.",
      ...
      moveHelp:
        "L'enregistrement définit ou les nouveaux matchs sont planifies. Pour déplacer maintenant les matchs déjà planifies vers le lieu attribue, utilisez les boutons ci-dessous.",
      ...
      moveError: 'Impossible de déplacer les matchs.',
    },
    list: {
  ...
  newEvent: {
    ...
    backToOrg: '{slug}',
    stepsLabel: "Etapes de création de l'événement",
    steps: {
      basics: 'Bases',
      lices: 'Lieu',
    ...
    kindHelp: {
      ...
      test: "Un essai. Masque des pages publiques, des espaces personnels et des statistiques, et supprimable définitivement même après l'enregistrement de matchs.",
    ...
    areaHint:
      'Ajoutez un espace seulement si vous voulez diviser le lieu en plusieurs zones de stages simultanées. Sinon, laissez vide.',
    venuePickExisting: 'Choisir un lieu existant',
    venueCreateNew: 'Créer un nouveau lieu',
    venuePickLabel: "Catalogue des lieux de l'organisation",
    venuePickPlaceholder: 'Sélectionnez un lieu...',
    venueLoading: 'Chargement des lieux...',
    venueCatalogueEmpty:
      'Aucun lieu dans cette organisation. Utilisez Créer un nouveau lieu pour en ajouter un.',
    ...
    validation: {
      ...
      endBeforeStart: 'La date de fin doit être après ou egale à la date de début',
      licesRequired: 'Au moins 1 lice est requise',
      licesNamesRequired: 'Tous les noms de lices doivent être remplis',
      areaNamesRequired: "Tous les noms d'espaces doivent être remplis",
      venueRequired: 'Choisissez un lieu dans le catalogue ou créez-en un.',
      ...
      venueCreateFailed: 'Impossible de créer le lieu',
  ...
  eventHub: {
    ...
    dashboard: {
      ...
      description: "Instantané operationnel de l'événement selectionne.",
      ...
      visibilityError: 'Impossible de changer la visibilité du tournoi.',
    },
    clubs: {
      title: 'Clubs',
      description:
        "Parcourez tous les clubs de la plateforme ou seulement ceux representes dans l'événement.",
      allClubs: 'Tous les clubs',
      eventClubs: 'Dans cet événement',
      searchLabel: 'Chercher des clubs',
      searchPlaceholder: 'Chercher par nom ou abréviation...',
      loadError: "Impossible de charger les clubs de l'événement.",
      empty: 'Aucun club trouve.',
      club: 'Club',
      location: 'Localisation',
      status: 'Statut',
      eventFighters: 'Combattants événement',
      actions: 'Actions',
      verified: 'verifie',
      ...
      submitHelp:
        "Créez un club non verifie maintenant et envoyez-le a l'équipe plateforme pour revue.",
      nameRequired: 'Nom *',
  ...
  live: {
    forbidden: "Vous n'avez pas accès à cet événement.",
  ...
  eventStats: {
    title: 'Statistiques',
    subtitle:
      'Analyse des combats et de la participation pour cet événement et chacun de ses tournois.',
    loadError: "Impossible de charger les statistiques de l'événement.",
    empty:
    ...
    band: {
      ...
      doublesHint: 'Taux de touche simultanée',
    ...
    tournament: {
      ...
      detail: 'Détail des échanges',
      loadingDetail: 'Chargement du détail...',
      detailError: 'Impossible de charger le détail du tournoi.',
      noStandings: 'Aucun classement pour le moment.',
      noFighters: 'Aucun échange marque pour le moment.',
    },
    distribution: {
      title: 'Répartition des échanges',
      clean: 'Propre',
      afterblow: 'Afterblow',
      double: 'Double',
    },
    ...
    referees: {
      ...
      subtitle: "Matchs arbitres sur l'ensemble de l'événement.",
      colReferee: 'Arbitre',
      colMatches: 'Matchs',
      colLead: 'Declarant',
  ...
  recap: {
    title: 'Recap IA',
    subtitle:
      'Générez un court recap de ce tournoi à partir des résultats, puis publiez-le sur la page publique.',
    language: 'Langue',
    generate: 'Générer le recap',
    regenerate: 'Régénérer',
    publish: 'Publier',
    unpublish: 'Depublier',
    published: 'Publie',
    draft: 'Brouillon',
    empty: 'Aucun recap pour le moment. Générez-en un à partir des résultats finaux.',
  ...
  chat: {
    ...
    description:
      "Posez des questions sur votre événement et proposez des actions de configuration. Les actions ne sont appliquées qu'après votre confirmation.",
    backToEvent: "Retour à l'événement",
    missingKey: 'Configurez une clé IA pour utiliser le chatbot.',
    configureKey: 'Configurer la clé IA',
    ...
    proposal: {
      ...
      applied: 'Appliquée',
      rejected: 'Ignorée',
      failed: 'Cette proposition comporte des erreurs de validation et ne peut pas être appliquée.',
    },
  },
  aiAssistant: {
    backToEvent: "Retour à l'événement",
    title: 'Assistant IA de préparation tournoi',
    description:
      'Créer des brouillons IA relus pour la configuration, les poules, les tableaux, le planning et les arbitres.',
    missingKey:
      "L'IA organisateur est désactivée tant que cette organisation n'a pas configuré de clé BYOK.",
    configureKey: 'Configurer la clé IA',
  ...
  tournamentQuery: {
    ...
    description:
      'Posez des questions en lecture seule sur le tournoi choisi, en français ou anglais.',
    tournament: 'Tournoi',
    question: 'Question',
    placeholder: "Posez une question - ex. 'Top 5 fighters by win rate'",
    ask: 'Demander',
    asking: 'Analyse...',
    queryError: 'La requête a echoue. Réessayez.',
    ...
    settings: 'Paramètres des questions',
    ...
    access: {
      ...
      anyone: 'Toute personne avec accès au tournoi',
    },
    suggestions: {
  ...
  compensationSettings: {
    ...
    createError: 'Impossible de créer le plan.',
    ...
    creating: 'Création...',
    emptyCustomPlans: 'Aucun plan personnalise. Créez-en un pour remplacer les taux integres.',
    public: 'public',
    ...
    from: 'De',
    to: 'A',
    noTiers: 'Aucun palier défini.',
    noMaximum: 'infini',
    addRow: '+ Ajouter une ligne',
    saveRates: 'Sauvegarder les taux',
    saveTiers: 'Sauvegarder les paliers',
    saving: 'Sauvegarde...',
    rateInputLabel: '{rôle} {phase} jetons par match',
  ...
  eventCompensation: {
    ...
    saveSettingsError: 'Sauvegarde des paramètres impossible.',
    selectPlanHelp: 'Choisissez un plan de compensation ci-dessus pour générer le rapport.',
    planLabel: 'Plan :',
    ...
    amount: 'Montant',
    paid: 'Paye',
    empty: 'Aucune affectation arbitre trouvée pour cet événement.',
  ...
  broadcast: {
    ...
    emptyHistory: 'Aucune diffusion envoyée.',
  ...
  bracket: {
    overrideModal: {
      ...
      liceLabel: 'Lice',
      liceNone: 'Non assignée',
      refereeNone: 'Non assigne',
    },
    autoPopulateButton: 'Remplir le tableau',
    autoPopulateModeOverall: 'Classement général',
    autoPopulateModeTopNPerPool: 'Top-N par poule',
    autoPopulateTopNLabel: 'Top N',
    autoPopulatePoolsNotFinished: 'Les poules ne sont pas encore terminées',
    autoPopulateSuccess: 'Tableau rempli à partir du classement des poules',
    autoPopulateSuccessFromSeed:
      "Tableau rempli à partir de l'ordre d'inscription (aucune donnée de poule)",
    autoPopulateSuccessFromRating: 'Tableau rempli à partir du classement HEMA',
    ...
    seedingTiedAtCut:
      'A egalite sur tous les departages configures : {fighters}. Le choix entre eux était arbitraire — allongez la chaine de departages ou organisez un barrage si cela compte.',
    autoPopulateNoPoolsTitle: 'Remplir le tableau sans données de poule ?',
    autoPopulateNoPoolsBody:
      "Ce tournoi n'a pas de phase de poules. Le tableau sera classé selon l'ordre d'inscription. Continuer ?",
  ...
  phaseVisibility: {
    ...
    updateError: 'Impossible de modifier la visibilité.',
    poolsReadyTitle: 'Les poules sont pretes',
    poolsReadyBody: 'Les poules sont publiées. Consultez votre poule et votre planning.',
    bracketReadyTitle: 'Le tableau est prêt',
    bracketReadyBody: 'Le tableau est publié. Consultez votre prochain match eliminatoire.',
    bracketSummaryPlayIns: '{count} barrages',
    playIns: 'Barrages',
    seedingStrategyLabel: 'Stratégie de tirage',
    ...
    seedingStrategyByPoolRank: 'Par rang de poule (poules terminées requises)',
    podiumTitle: 'Podium',
    podiumGold: 'Or',
    podiumSilver: 'Argent',
    podiumBronze: 'Bronze',
    ...
    configLocked: 'Configuration verrouillée - au moins un match est terminé.',
    reseedButton: 'Re-tirer le 1er tour',
    reseedTitle: 'Re-tirer le 1er tour',
    reseedHint:
      'Choisissez une stratégie et appliquez-la au 1er tour. Les matchs déjà lances ne peuvent pas être re-tires.',
    reseedStrategyLabel: 'Stratégie',
    reseedApply: 'Appliquer',
    reseedApplying: 'Application...',
    reseedBlocked: 'Certains matchs du 1er tour sont déjà lances - re-tirage impossible.',
  ...
  swiss: {
    page: {
      ...
      description:
        "Chaque combattant dispute le même nombre de rondes, apparie à chaque fois avec quelqu'un au palmares proche. Personne n'est elimine et le classement découle des résultats.",
    ...
    tabs: {
      ...
      referees: 'Arbitres',
      disabledHint: "Générez d'abord la phase suisse.",
    },
    errors: {
    ...
    configure: {
      ...
      roundCountHelp:
        "Chaque combattant dispute ce nombre de rondes. En dessous de trois le classement n'a pas de sens ; au-dessus de neuf un événement d'une journée manque de temps.",
      recommended: 'Recommande : {count} pour {fighters} combattants',
      seeding: 'Tirage de la ronde 1',
      seedingLocked: 'Le tirage est figé une fois la phase créée. Régénérez pour le changer.',
      seedingOption: {
      ...
      seedingHint: {
        random: 'Rejouable : la graine est enregistrée, un tirage conteste peut être reproduit.',
        'by-rating':
          "Lit l'instantané hemaratings.com pour cette arme. Refuse plutot que de classer les non-notes en dernier.",
        'by-pool-rank': "Nécessite une phase de poules terminée pour en lire l'ordre.",
      },
      ...
      minCoverage: 'Couverture minimale notée (%)',
      minCoverageHelp:
        "En dessous, le tirage par classement est refusé. Un tirage qui retombe en silence sur l'ordre d'inscription à l'air classe et ne l'est pas.",
      ...
      frozenAfterRound2:
        'Fige à partir de la ronde 2 : le modifier reecrirait la valeur des rondes déjà disputées.',
      groupingTitle: "L'appariement groupe sur",
      groupingExplainer:
        "Le système suisse apparie sur une valeur EGALE. Ce n'est pas le même reglage que celui du classement : un score continu donne à chacun une valeur unique, donc chaque groupe ne contiendrait qu'une personne et l'appariement degenererait en 1c2, 3c4.",
      grouping: {
        points: 'Points suisses',
        pointsHint: 'Discret 3 / 1 / 0. Le défaut, et ce qui garde le format suisse.',
        scoreBands: 'Tranches de score',
        scoreBandsHint:
          'Groupe un score continu en tranches que vous définissez. Utile quand les points suisses sont trop grossiers.',
      },
      boundariesLabel: 'Bornes des tranches, croissantes',
      boundariesHint:
        "Entre 1 et 10 bornes, strictement croissantes. L'aperçu ci-dessous utilise la fonction qui apparie réellement.",
      bandsNoData: "Pas encore de classement - l'aperçu apparaît après une ronde arbitrée.",
      ...
      rankingExplainer:
        "Ce qui décide l'ordre final. Indépendant de ce sur quoi l'appariement groupe ci-dessus.",
      rankBy: {
        swissPts: 'Points suisses',
        swissPtsHint: 'Victoires, nuls et exempts aux valeurs définies ci-dessous.',
        rulesetScore: 'Le score du règlement',
        rulesetScoreHint:
          "Propose pour tout règlement. Si le règlement ne declare aucune colonne de score, elle est ajoutée au tableau - personne n'est classé sur un nombre invisible.",
      },
      points: {
        win: 'Victoire',
        draw: 'Nul',
      ...
      tiebreakExplainer:
        "Appliquée dans l'ordre pour departager les ex aequo. « Chaine du règlement » insere ce que ce règlement fait normalement.",
      tiebreakEmpty: "Aucun departage : les ex aequo restent dans l'ordre du tirage.",
      removeTiebreak: 'Retirer',
      moveUp: 'Déplacer {key} plus tôt',
      moveDown: 'Déplacer {key} plus tard',
      lifecycleTitle: 'Phase',
      generate: 'Générer la phase suisse',
      generated: 'Phase suisse générée.',
      save: 'Enregistrer la configuration',
      saved: 'Configuration enregistrée.',
      regenerate: 'Régénérer',
      regenerateTitle: 'Régénérer la phase suisse ?',
      regenerateBody:
      ...
      finalisedAt: 'Classement final après {round} rondes sur {total}.',
      resume: 'Reprendre',
      resumed: 'Phase reprise.',
      assignReferees: 'Affecter les arbitres',
      entrantsTitle: 'Participants ({count})',
      withdrawHint:
        'Un forfait ne participe plus aux rondes suivantes. Les rondes déjà disputées restent acquises et comptent pour ses adversaires.',
      withdraw: 'Forfait',
      withdrawn: 'Combattant declare forfait.',
      withdrawnAt: 'sorti à la ronde {round}',
    },
    rounds: {
      noPhase: 'Pas encore de phase suisse.',
      empty: 'Aucune ronde appariée.',
      progress: '{done} rondes terminées sur {total}',
      roundTitle: 'Ronde {round}',
      finalisedBanner: 'Le classement est figé. Reprenez la phase pour modifier les rondes.',
      advanced: 'Afficher les corrections avancées',
      manuallyAdjusted: 'Ajuste manuellement',
      forcedRematch: 'Re-rencontre forcée',
      bye: 'Exempt',
      swapHint: 'Cliquez un combattant, puis un autre de la même ronde, pour les echanger.',
      swapped: 'Combattants échanges.',
      swapWarningTitle: 'Echanger quand même ?',
      swapWarningConfirm: 'Echanger quand même',
      swapWarning: {
        'creates-rematch': '{fighters} se sont déjà rencontres dans cette phase.',
        'repeat-bye': '{fighters} a déjà été exempt.',
        'same-club': '{fighters} sont du même club.',
      },
      setSides: 'Inverser les cotes',
      setSidesHelp:
        'Écrit les deux cotes de ce combat directement. Peut rendre la ronde invalide, ce qui bloque la suivante.',
      sidesSet: 'Cotes mises à jour.',
      delete: 'Supprimer la ronde',
      deleteTitle: 'Supprimer la ronde {round} ?',
      deleteBody:
        'Cela retire la ronde et ses {count} combat(s). Seule la dernière ronde peut partir.',
      deleteConfirm: 'Supprimer la ronde',
      deleted: 'Ronde supprimée.',
    ...
    standings: {
      ...
      after: 'Après {done} rondes sur {total}',
      rankedBy: {
        swissPts: 'classe sur les points suisses',
        rulesetScore: 'classe sur le score du règlement',
      },
    ...
    referees: {
      ...
      empty: 'Aucune ronde suisse à couvrir.',
      ...
      clearBody: 'Toutes les affectations sur toutes les pistes de cette ronde sont retirées.',
  ...
  schedulePage: {
    ...
    title: 'Programme',
    generateScheduleAction: 'Générer le programme',
    generateGridAction: 'Générer la grille',
    ...
    generateToastShowDetails: 'Voir le détail par bloc',
    generateToastHideDetails: 'Masquer le détail par bloc',
    ...
    planner: {
      ...
      config: {
        ...
        perTournament: {
          ...
          blankMeansEvent: "Laissez une case vide pour reprendre la valeur de l'événement.",
          pool: 'Poule',
          swiss: 'Suisse',
          elimination: 'Élim.',
          finals: 'Finale',
          ...
          rest: 'Pause',
          restAria: 'Pause pour {tournament}, en minutes. Zéro signifie aucune pause.',
        },
      },
      sheetLoadFailed:
    ...
    grid: {
      ...
      runningLateButton: '⏱ En retard — {min} min',
      runningLateTitle: 'Décaler la suite de la journée, barres et combats ensemble',
      runningLateHeading: 'En retard',
      runningLateBasis: '{lice} a {min} min de retard, mesuré sur {basis}.',
      runningLateAmount: 'Décaler la suite de la journée de',
      runningLateMinutes: 'min',
      runningLateFrom: 'À partir de {time}, le {day}.',
      runningLateMoves: 'Barres à décaler : {bars}. Combats à décaler : {fights}.',
      runningLateKeeps: 'Les combats déjà disputés, ou en cours sur une lice, ne bougent pas.',
      runningLateConfirm: 'Décaler la journée',
      runningLateCancel: 'Annuler',
      runningLateBusy: 'Décalage…',
      ...
      conflictSegAnd: 'et',
      conflictSegAt: 'à',
      refereeTitle: "⚠ Conflits d'arbitrage",
      refereeLiveGroup: "Vérifié à l'instant, combat par combat",
      refereeCrewGroup: 'Équipes de poule, dernière lecture à {time}',
      refereeCrewNone: "Aucun conflit d'équipe de poule à ce moment-là.",
  ...
  pools: {
    ...
    configure: {
      ...
      help: {
        schoolSeparation:
          'Les combattants du même club sont places dans des poules differentes autant que possible.',
        skillBalance:
          'Les poules sont seedées de sorte que les niveaux de classement sont repartis équitablement.',
      },
    },
    matches: {
      round: 'Manche',
  ...
  staff: {
    ...
    staffLoginHelp:
      "C'est ici que les arbitres se connectent avec leur identifiant et leur PIN — pas dans l'application spectateur. Le lien ouvre la tablette de scoring avec cet événement déjà renseigné.",
    staffLoginUrl: 'Lien de connexion staff pour cet événement',
  ...
  hemaRatings: {
    ...
    blockedKind:
      'Seuls les événements standard peuvent être soumis à HEMA Ratings. Les résultats des événements de test et de club ne comptent pas pour les classements.',
  ...
  archive: {
    ...
    downloadFullCsv: 'Événement complet (CSV)',
    downloadFullJson: 'Événement complet (JSON)',
  ...
  persons: {
    addAsReferee: 'Inscrire aussi comme arbitre pour cet événement',
    refereeColumn: 'Arbitre',
    addAsInstructor: 'Marquer aussi comme instructeur pour cet événement',
    ...
    instructorRegistrationFailed:
      'Impossible de marquer comme instructeur. Réessayez depuis la page Participants.',
    instructorUpdateFailed:
      "Impossible de mettre à jour le statut d'instructeur. Les autres modifications ont été enregistrées.",
    ...
    tournamentFullDescription:
      "Le(s) tournoi(s) suivant(s) ont atteint leur capacite. Ajouter sur la liste d'attente à la place ?",
    tournamentFullEntry: '{tournamentName} ({count} / {max}) — {personName}',
    addToWaitingList: "Ajouter à la liste d'attente",
    addedToWaitingListSingular: "Ajoute à la liste d'attente.",
    ...
    addToWaitingListAllFailed: "Aucun ajout à la liste d'attente n'a abouti.",
    refereeRegistrationFailed:
      "Impossible d'inscrire comme arbitre. Essayez depuis la page Arbitres.",
    refereeUnclaimedHint:
      'Inscrit comme arbitre. Il verra ses affectations après avoir revendique son compte.',
    refereeUnclaimedBadge: 'non revendique',
    refereeUpdateFailed:
      "Impossible de mettre à jour le statut d'arbitre. Les autres modifications ont été enregistrées.",
    hemaFinder: {
      colName: 'Nom',
      colClub: 'Club',
      colCountry: 'Pays',
    ...
    bulk: {
      ...
      assignToAnother: 'Inscrire à un autre…',
      assign: 'Inscrire',
  ...
  deletionRequest: {
    ...
    requestDeletionModalTitleEvent: "Demander la suppression de l'événement",
    ...
    requestDeletionModalReasonPlaceholder:
      'Decrivez pourquoi cet element doit être supprime (10-500 caractères)...',
    requestDeletionSubmit: 'Envoyer la demande',
    cancelRequest: 'Annuler la demande',
    archivedReadOnly: 'Cet événement est archivé et en lecture seule.',
    archivedBannerCopy:
      "Cet événement est archivé et en lecture seule. La modification n'est plus disponible.",
    archivedBannerCta: 'Demander la suppression',
    archivedBannerPendingCopy:
      'Suppression demandée par {requester} le {date} — en attente de revue super-admin.',
    archivedLastArchivedOn: 'Archive le {date}',
    deletionRequestSubmitted: 'Demande de suppression envoyée. Un super-admin va la revoir.',
    deletionRequestCancelled: 'Demande de suppression annulée.',
    deletionRequestConflict: 'Une demande de suppression est déjà en attente pour cet element.',
    autoArchiveNotice:
      'En envoyant, cet événement sera archivé et une demande de suppression sera envoyée aux admins MyClash pour revue.',
    permanentDeleteWarning:
      'Une fois approuve par un super-admin, cet événement est définitivement supprime. Ses matchs et résultats ne seront PAS conserves et seront exclus des statistiques, classements et historiques des combattants.',
  ...
  staffing: {
    tournamentLabel: 'Tournoi',
    eventDefault: "Défaut de l'événement",
    overrideToggle: 'Surcharger pour ce tournoi',
    usingHardCodedFloor:
      'Aucune config enregistrée — affichage du défaut plateforme (Declarant / Assesseur / Table par phase).',
    inheritingExplanation:
      "Ce tournoi herite du défaut de l'événement. Activez 'Surcharger pour ce tournoi' pour editer.",
    resetToEventDefault: "Réinitialiser au défaut de l'événement",
    resetError: 'Impossible de réinitialiser.',
    resetDone: "Reinitialise au défaut de l'événement.",
    loading: 'Chargement de la config...',
    slotCount: 'Nombre de creneaux',
    slotLabel: 'Créneau {index}',
    displayNamePlaceholder: "Nom d'affichage (optionnel)",
    addSkillToSlot: 'Ajouter une compétence',
    removeSkillFromSlot: 'Retirer cette compétence du créneau',
  ...
  refereesPage: {
    ...
    catalogDeleteConfirm:
      'Supprimer "{name}" ? Personnalisées uniquement — les compétences système sont protégées.',
    catalogDeleteConfirmTitle: 'Supprimer la compétence',
    catalogDeleteConfirmAction: 'Supprimer',
    catalogDeleteBlocked: 'Suppression impossible : compétence encore référencée.',
    catalogDeleteFailed: 'Impossible de supprimer la compétence.',
    catalogDeleteSuccess: 'Compétence supprimée.',
    ...
    catalogVisibilityFailed: 'Impossible de mettre à jour la visibilité.',
    ...
    skillDeleteConflict: 'Suppression impossible : {count} arbitre(s) ont encore cette compétence.',
    skillDeleteInUse: 'Impossible de supprimer cette compétence — elle est encore utilisée.',
    skillDeleteFailed: 'Impossible de supprimer la compétence.',
    skillSaveFailed: "Impossible d'enregistrer la compétence.",
    availabilitySaveFailed: 'Impossible de mettre à jour la disponibilité.',
    skillNameRequired: 'Le nom de la compétence est obligatoire.',
    ...
    unlockAssignments: 'Déverrouiller les affectations',
    ...
    assignmentUnlockFailed: 'Impossible de déverrouiller les affectations arbitres.',
    lockedBanner:
      'Les affectations sont verrouillées. Cliquez sur "Déverrouiller les affectations" pour modifier.',
