...
| `enforce_fighter_referee_no_overlap`                                      | Already correct under the ruling, and renaming forces DROP + re-ADD of a CHECK that CLAUDE.md hard rule 8 forbids disabling. (Column dropped in 0209, W1.4: it gated nothing.)                         |
