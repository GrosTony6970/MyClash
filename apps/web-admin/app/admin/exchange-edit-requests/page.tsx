  ...
  return (
    <main className="p-8">
      ...
      {items.length === 0 && !loading ? (
        <p className="text-gray-400 text-sm">No exchange edit requests match this status.</p>
      ) : (
              ...
              {items.map((request) => (
                ...
                >
                  ...
                  <td className="py-3 pr-4">
                    ...
                    <span className="mt-1 inline-block rounded bg-gray-100 px-2 py-1 font-mono text-xs">
                      {request.status}
                    </span>
                  </td>
                  ...
                  <td className="py-3 pr-4 max-w-xs text-gray-700">{request.reason}</td>
                  <td className="py-3 pr-4">
                  ...
                  <td className="py-3">
                    <pre className="max-w-sm whitespace-pre-wrap break-words text-xs text-gray-500">
      ...
      {rejectTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            ...
            <p className="mt-1 text-sm text-gray-500">{typeLabel(rejectTarget.request_type)}</p>
            <textarea
              value={rejectReason}
              onChange={(event) => setRejectReason(event.target.value)}
              rows={4}
              placeholder="Reason shown to requester"
              className="mt-4 w-full resize-none rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-600"
            />
