/**
 * Club + referee filter predicate for the event Persons page, applied
 * inside the page's filteredPersons memo alongside the name search and
 * the tournament tabs. Referee status keys on global_persons.id (the
 * event_referees identity), matched against person.globalPersonId — the
 * same comparison the page's Referee column uses.
 *
