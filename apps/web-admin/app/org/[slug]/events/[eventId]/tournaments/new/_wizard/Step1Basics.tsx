...
interface PenaltyRuleset {
  id: string;
  name: string;
  /** Platform built-in (the FFAMHE penalty ruleset) — used to pre-select a default. */
  built_in?: boolean;
  code?: string;
}
    ...
    <div className="space-y-4">
      ...
      <label className="block">
        ...
        <input
          ...
          className="w-full rounded-md border border-border px-3 py-2 text-sm font-mono disabled:bg-background"
        />
      </label>
      ...
      <fieldset className="space-y-2">
        ...
        <p className="text-[11px] text-muted">{t('organizer.tournaments.settings.colorHelp')}</p>
      </fieldset>
