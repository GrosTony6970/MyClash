...
export class AuthService {
  ...
  async getMe(request: FastifyRequest): Promise<MeResponseDto> {
    ...
    // Look up any Person linked to this user
    // NOTE: persons table is created in T-101. This query is safe to fail
    // gracefully until then — the user is still 'claimed' without a person.
